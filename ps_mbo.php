...
//
//        if ($controllerName === 'AdminThemes') {
//            $this->smarty->assign('admin_module_ajax_url_psmbo', $this->context->link->getAdminLink('AdminPsMboModule'));
//
//            return $this->fetch('module:ps_mbo/views/templates/hook/admin-end-content-theme.tpl');
//        }
//
//        $content = $this->fetch('module:ps_mbo/views/templates/hook/admin-end-content-modal-recommanded.tpl');
//
//        if (in_array($controllerName, ['AdminCarriers', 'AdminPayment'])) {
//            $this->smarty->assign([
//                'admin_module_ajax_url_psmbo' => $this->context->link->getAdminLink('AdminPsMboModule'),
//                'controller_page' => $controllerName,
//            ]);
//
//            if ($this->isSymfonyContext()) {
//                $content .= $this->fetch('module:ps_mbo/views/templates/hook/admin-end-content.tpl');
//            } else {
//                $content .= $this->fetch('module:ps_mbo/views/templates/hook/admin-end-content-legacy.tpl');
//            }
//        }
//
//        return $content;
     ...
     * @return bool
     */
    protected function shouldAttachRecommendedModulesButton()
    {
