    ...
    $(".modules-list").each(function() {
      ...
      container.find(".module-item").each(function() {
        ...
        self.modulesList.push({
          ...
          name: (typeof $this.attr('data-name') !== 'undefined') ? $this.attr('data-name').toLowerCase() : '',
          scoring: parseFloat($this.attr('data-scoring')),
          logo: $this.attr('data-logo'),
          author: (typeof $this.attr('data-author') !== 'undefined') ? $this.attr('data-author').toLowerCase() : '',
          version: $this.attr('data-version'),
          description: (typeof $this.attr('data-description') !== 'undefined') ? $this.attr('data-description').toLowerCase() : '',
          techName: (typeof $this.attr('data-tech-name') !== 'undefined') ? $this.attr('data-tech-name').toLowerCase() : '',
          childCategories: $this.attr('data-child-categories'),
          categories: (typeof $this.attr('data-categories') !== 'undefined') ? $this.attr('data-categories').toLowerCase() : '',
