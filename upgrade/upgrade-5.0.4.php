 ...
 * @return bool
 */
function upgrade_module_5_0_4()
{
    $moduleDir = _PS_MODULE_DIR_ . 'ps_mbo';

    try {
        deleteFolderRecursively($moduleDir . '/vendor/guzzlehttp/guzzle');
        deleteFolderRecursively($moduleDir . '/vendor/guzzlehttp/ringphp');
        deleteFolderRecursively($moduleDir . '/vendor/guzzlehttp/streams');
        deleteFolderRecursively($moduleDir . '/vendor/prestashop/circuit-breaker');
        deleteFolderRecursively($moduleDir . '/vendor/symfony/polyfill-php73');
        deleteFolderRecursively($moduleDir . '/vendor/psr/log/Psr');
        deleteFolderRecursively($moduleDir . '/vendor/paragonie');
        deleteFolderRecursively($moduleDir . '/vendor/ramsey');
        deleteFolderRecursively($moduleDir . '/vendor/react');
        ...
        safeUnlink($moduleDir . '/config/services/overrides.yml');
        safeUnlink($moduleDir . '/gha-creds-8ca2dae6482597be.json');
        safeUnlink($moduleDir . '/src/Addons/AddonsDataProvider.php');
        safeUnlink($moduleDir . '/src/Helpers/AsyncClient.php');
        safeUnlink($moduleDir . '/src/Service/MboSymfonyCacheClearer.php');
        safeUnlink($moduleDir . '/src/Service/ModuleInstaller.php');
        safeUnlink($moduleDir . '/src/Traits/HaveShopOnExternalService.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseActionGeneralPageSave.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseActionModuleRegisterHookAfter.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseActionObjectEmployeeDeleteBefore.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseActionObjectEmployeeUpdateBefore.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseActionObjectShopUrlUpdateAfter.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseDashboardZoneTwo.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseDisplayBackOfficeEmployeeMenu.php');
        safeUnlink($moduleDir . '/src/Traits/Hooks/UseDisplayModuleConfigureExtraButtons.php');
        safeUnlink($moduleDir . '/vendor/symfony/workflow/Exception/InvalidTokenConfigurationException.php');
